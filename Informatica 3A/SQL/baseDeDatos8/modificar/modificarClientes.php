...
<body>
    ...
    <div class="content">
        <ul class="content">
            <li><a href="modificarClientes.php" class="selected">Clientes</a></li>
            <li><a href="modificarProductos.php">Productos</a></li>
            <li><a href="modificarProveedores.php">Proveedores</a></li>
        </ul>
        <div class="container">
            <form action="modificar.php" method="post">
            <h3>Ingrese el codigo del cliente a modificar</h3>
                ...
                for ($z=0;$z<$cantfilas;$z++){
                    ...
                    echo("<option value=".$fila["codigoClie"].">".$fila["codigoClie"]."</option>");
                }
                echo("</select>");
                ?>
            <h4>Nuevo nombre</h4>
