<?php
    ...
    $tablaUno="CREATE TABLE Uno (
        id int AUTO_INCREMENT,
        Username varchar(20) NOT NULL,
        Password varchar(20) NOT NULL,
        PRIMARY KEY (id)
    );";
    $tablaDos="CREATE TABLE Dos (
        id int AUTO_INCREMENT,
        Username varchar(20) NOT NULL,
        Password varchar(20) NOT NULL,
        PRIMARY KEY (id)
    ...
    mysqli_select_db($link,"Examen") or die ("<br>ERROR AL SELECCIONAR LA BASE DE DATOS");
    echo ("<br>Se selecciono la base de datos con exito");
    mysqli_query($link,$tablaUno) or die ("<br>ERROR AL EJECUTAR COMANDO SQL 1");
    echo("<br>Se ha creado la tabla");
    mysqli_query($link,$tablaDos) or die ("<br>ERROR AL EJECUTAR COMANDO SQL 1");
    echo("<br>Se ha creado la tabla");
