...
<body>
    ...
    <div class="content">
        <ul class="content">
            <li><a href="eliminarClientes.php" class="selected">Clientes</a></li>
            <li><a href="eliminarProductos.php">Productos</a></li>
            <li><a href="eliminarProveedores.php">Proveedores</a></li>
        </ul>
        <div class="container">
            <form action="eliminar.php" method="post">
                <h3>Ingrese el codigo del cliente a eliminar</h3>
